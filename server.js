    ...
    app.get('/test-db',function(req,res){
        pllo.query('SELECT * FROM test',function(err,result){
            if(err)
            {
    ...
    app.get('/article-one2', function (req, res) {
      res.sendFile(path.join(__dirname, 'ui', 'article-one2.html'));
    }); 
    app.get('/:articleName',function(req,res){
        //artcleName will be article-one 
